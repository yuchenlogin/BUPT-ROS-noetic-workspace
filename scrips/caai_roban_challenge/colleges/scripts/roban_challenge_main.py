...
from lejulib import *
from Task_carry_box import Task_carry_box
from Task_identify_numbers import Task_Identify_numbers
...
class RaceNode(Task_carry_box,Task_Identify_numbers,Task_path_tracking):
