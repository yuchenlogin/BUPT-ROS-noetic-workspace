...
class Detecter():
        ...
        try:
            if self.__debug:
                ...
                for i in range(4):
                    ...
                    contours = list(contours) ## opencv版本变化导致输出类型变化，将元组类型转化成原来的列表
                    # 打印检测到的轮廓数量
            ...
            print(f"Error in the callback process: {e}")
    ...
    def detect(self):
        ...
        try:
            ...
            print(f"Error in the detection process: {e}")
