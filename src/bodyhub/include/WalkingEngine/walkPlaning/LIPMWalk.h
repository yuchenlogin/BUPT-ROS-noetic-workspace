...
namespace GaitManager
{
  ...
  public:
    ...
    Eigen::Vector6d cubicsplineFootPx_wf, cubicsplineFootAx_wf,
        ...
        cubicsplineFootPz1_wf, cubicsplineFootAz1_wf,
        cubicsplineFootPz2_wf, cubicsplineFootAz2_wf,
    ...
    typedef struct
    {
      int8_t i;
      sva::PTransformd pt;
      Eigen::Vector3d gait_cmd;
      PhaseOfStep phase;
      uint32_t count;
    } IKContext_t;

  public:
    void setIKFailedCallback(void (*fp)(const IKContext_t ik_c));

  private:
    IKContext_t ik_context_;
    void (*ik_f_cb_)(const IKContext_t ik_c){NULL};
  };
