...
namespace Human
{
	...
	public:
		...
		rbd::MultiBody leftLegMb;
		rbd::MultiBodyConfig leftLegMbc;

		rbd::MultiBodyGraph rightLegMbg;
		rbd::MultiBody rightLegMb;
	...
	private:
		...
		Eigen::Matrix<double, 6, 1> leftLeg_qref;
		Eigen::Matrix<double, 6, 1> leftLeg_qrefOld;
		Eigen::Matrix<double, 6, 1> leftLeg_q;
		Eigen::Matrix<double, 6, 1> leftLeg_qold;
		Eigen::Matrix<double, 6, 1> leftLeg_dqref;
		Eigen::Matrix<double, 6, 1> leftLeg_dqrefOld;
		Eigen::Matrix<double, 6, 1> leftLeg_dq;
