...
void RobotDynamics::jointParaInit()
{
	...
	// mbc.zero(mb);
	// mbc.q={{},
	// {0.*TO_RADIAN},{5.*TO_RADIAN},{-10.*TO_RADIAN},{-20.*TO_RADIAN},{10.*TO_RADIAN},{5.*TO_RADIAN},{}    //leftLeg
	// ,{0.*TO_RADIAN},{-5.*TO_RADIAN},{-10.*TO_RADIAN},{-20.*TO_RADIAN},{10.*TO_RADIAN},{-5.*TO_RADIAN},{}};    //rightLeg
	...
	qref = sParamToVector(mb, mbc.q);
	dqref = sDofToVector(mb, mbc.alpha);
	qrefOld = qref;
	qold = qref;
	dqrefOld = dqref;

	// FloatMbc.zero(FloatMb);
	// FloatMbc.q={{1.,0.,0.,0.,0.,0.,0.3},
	// {0.*TO_RADIAN},{-3.5*TO_RADIAN},{-18.*TO_RADIAN},{44.*TO_RADIAN},{-26.*TO_RADIAN},{3.5*TO_RADIAN},{}    //leftLeg
	// ,{0.*TO_RADIAN},{3.5*TO_RADIAN},{-18.*TO_RADIAN},{44.*TO_RADIAN},{-26.*TO_RADIAN},{-3.5*TO_RADIAN},{}};    //rightLeg
	...
	float_qref = sParamToVector(FloatMb, FloatMbc.q);
	float_dqref = sDofToVector(FloatMb, FloatMbc.alpha);
	float_qrefOld = float_qref;
	float_qold = float_qref;
	float_dqrefOld = float_dqref;
}
